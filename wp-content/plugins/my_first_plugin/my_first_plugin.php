...
class WordCountAndTimePlugin{
    ...
    function createHTML($content){
        ...
        if(get_option('wcp_realtime','1')){
            $html.='this post will take about '. round($wordCount/225) . ' minite(s) to read.<br>';
        }
        $html .= '</p>';
    ...
    function settings(){
        ...
        add_settings_field('wcp_realtime','Real Time',array($this,'checkboxHTML'),'word-count-settings-page','wcp_first_section',array('theName'=>'wcp_realtime'));
    ...
    <?php }
    function adminPage(){
        add_options_page('Word Count Setting','Word Count','manage_options'
        ,'word-count-settings-page',array($this,'ourHTML'));
    }
    function ourHTML(){?>
    <div class="wrap">
